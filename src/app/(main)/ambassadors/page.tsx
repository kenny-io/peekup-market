...
const benefits = [
  {
    ...
    description: 'Earn a monthly stipend for your work. Lead Ambassadors earn the highest tier.',
...
const stats = [
  ...
  { value: 'Paid', label: 'Monthly Stipends', mono: false },
      ...
      <section className="relative min-h-screen overflow-hidden bg-gray-900">
        ...
        <Container className="relative flex min-h-screen items-center justify-center py-20">
          ...
          >
            ...
            >
              Only 30 spots available — 3 per campus.
            </motion.p>
            <motion.div
              className="mt-8 rounded-2xl border border-[#25D366]/20 bg-[#25D366]/5 px-6 py-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.65 }}
            >
              <p className="text-sm font-semibold text-white">
                Next step: Join the Ambassador Group
              </p>
              <p className="mt-1 text-xs text-gray-400">
                All updates, shortlist announcements, and onboarding will happen
                exclusively in our WhatsApp group. Join now so you don&apos;t
                miss anything.
              </p>
              <a
                href="https://chat.whatsapp.com/Ks4HPjLUhH60WiDvLJnFst"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-6 py-3 text-sm font-semibold text-white shadow-lg transition hover:bg-[#1ebe57]"
              >
                  ...
                  <StepPanel isActive={step === 6}>
                    ...
                    <div className="space-y-5">
                      ...
                      <RadioGroup
                        ...
                        description="Lead Ambassadors earn the highest stipend tier, coordinate other ambassadors, and are first in line for future paid roles."
