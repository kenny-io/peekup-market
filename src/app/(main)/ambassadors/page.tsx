      ...
      <section className="relative min-h-screen overflow-hidden bg-gray-900">
        ...
        <Container className="relative flex min-h-screen items-center justify-center py-20">
          ...
          >
            ...
            >
              All updates, shortlist announcements, and onboarding happen
            ...
            >
              <a
                ...
                className="inline-flex items-center gap-2.5 rounded-xl bg-[#25D366] px-7 py-3.5 text-base font-semibold text-white shadow-lg transition hover:bg-[#1ebe57]"
              >
                ...
                Join Peekup Ambassadors on WhatsApp
              </a>
            </motion.div>
            <motion.div
              className="mt-6"
