...
import { allArticles, getCategoryColorClass } from '@/lib/blog-articles'
      ...
      <Container>
        ...
        <div className="mt-20 rounded-3xl bg-orange-600 px-8 py-12 text-center text-white sm:px-16">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <Button href="/business" variant="outline" color="transparent" className="text-white border-white hover:bg-white/10">
              List Your Business
            </Button>
          </div>
        </div>
