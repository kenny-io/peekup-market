...
function DeviceUserIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#f97316" fillOpacity={0.15} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
...
function FeaturesDesktop() {
  ...
  let onChange = (index: number) => setSelectedIndex(index)
...
export function PrimaryFeatures() {
  return (
    <section
      id="features"
      aria-label="Peekup marketplace features"
      className="bg-gray-900 py-20 sm:py-32"
    >
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
          Everything you need, delivered without stress.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            Peekup connects you to local businesses with one cart per vendor. Our riders buy in-store and deliver to your door, day or night.
          </p>
        </div>
      </Container>
